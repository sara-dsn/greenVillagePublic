 ...
 */
final class Version20241126115220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, instrument_id INT DEFAULT NULL, sans_fond VARCHAR(255) DEFAULT NULL, avec_fond VARCHAR(255) DEFAULT NULL, INDEX IDX_14B78418CF11D9C (instrument_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
