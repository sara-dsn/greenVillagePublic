 ...
 */
final class Version20241202134558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, siret VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, numero_telephone INT NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, mot_de_passe_temporaire VARCHAR(255) DEFAULT NULL, derniere_connexion DATE NOT NULL, coeff_vente INT DEFAULT NULL, reference_client VARCHAR(255) NOT NULL, total_acomptes DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
