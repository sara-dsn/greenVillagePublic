 ...
 */
final class Version20241216140123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, siret VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, numero_telephone INT NOT NULL, mot_de_passe_temporaire VARCHAR(255) DEFAULT NULL, derniere_connexion DATE NOT NULL, coeff_vente INT DEFAULT NULL, reference_client VARCHAR(255) NOT NULL, total_acomptes DOUBLE PRECISION DEFAULT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', verifie TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (mail), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE description (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, instrument_id INT DEFAULT NULL, libelle VARCHAR(255) DEFAULT NULL, info VARCHAR(255) DEFAULT NULL, INDEX IDX_6DE44026727ACA70 (parent_id), INDEX IDX_6DE44026CF11D9C (instrument_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE instrument (id INT AUTO_INCREMENT NOT NULL, couleur_id INT NOT NULL, tva_id INT NOT NULL, reference_fournisseur_id INT NOT NULL, rubrique_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, stock_unite INT NOT NULL, prix_ht DOUBLE PRECISION NOT NULL, INDEX IDX_3CBF69DDC31BA576 (couleur_id), INDEX IDX_3CBF69DD4D79775F (tva_id), INDEX IDX_3CBF69DD3E9CB05D (reference_fournisseur_id), INDEX IDX_3CBF69DD3BD38833 (rubrique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, instrument_id INT DEFAULT NULL, sans_fond VARCHAR(255) DEFAULT NULL, avec_fond VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_14B78418CF11D9C (instrument_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE description ADD CONSTRAINT FK_6DE44026CF11D9C FOREIGN KEY (instrument_id) REFERENCES instrument (id)');
        ...
        $this->addSql('ALTER TABLE photo ADD CONSTRAINT FK_14B78418CF11D9C FOREIGN KEY (instrument_id) REFERENCES instrument (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE description DROP FOREIGN KEY FK_6DE44026CF11D9C');
        ...
        $this->addSql('ALTER TABLE photo DROP FOREIGN KEY FK_14B78418CF11D9C');
